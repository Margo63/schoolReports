...
public class Unit7Response {
    ...
    private Long professionalDevelopment;

    public Unit7Response(Long[] theNumberOfEmployeesIsTotal, Long[] seniorStaffTotal, Long[] seniorStaff, Long[] deputyHeads, Long[] branchManager, Long[] teachingStaffTotal, Long[] teachersOfAdditionalEducation, Long[] trainingAndSupportStaff, Long[] otherStaff, Long professionalDevelopment) {
    ...
    public Long getProfessionalDevelopment() {
